...
namespace ThroneOfTides.Systems
{
    ...
    public class CannonballVFXController : MonoBehaviour, ICardPlayEffect
    {
        ...
        [Tooltip("Tune relative weight per prefab - e.g. Pistol lighter than Cannonball/Chain Shot.")]
        [SerializeField] private ScreenShakeLevel _shakeLevel = ScreenShakeLevel.Level2;
        ...
        {
            _context = context;
            // This controller always shakes the camera itself, timed to the ball's own deferred
            // impact - the generic instant on-damage shake would otherwise double up with it.
