...
namespace Water2D
{
    ...
    public class LayerRenderer
    {
        ...
        public void Setup(Transform holder, int layers, Vector2 scale, float resolution = 1, RenderTextureFormat format = RenderTextureFormat.ARGB32, FilterMode filterMode = FilterMode.Point, float bitdepth = 0, MonoBehaviour context = null, bool centerPerspectiveMargins = false)
        {
